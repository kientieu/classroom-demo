...
if (isset($_POST['action'])) {
    $action = $_POST['action'];
    if ($action == 'accept') {
        class_user_controller::add_user_to_new_class($_GET['username'], $_GET['classId'],1);
...
if (isset($_GET['username']) && isset($_GET['classId'])) {
...
if (!empty($error)) {
    ...
    <div class="row">
        <div class="col-md-6 mt-5 mx-auto p-3 border rounded">
            <h4>Confirm request attending class <?= $className; ?></h4>
            <p class="text-success">To attend class: Click <b>Accept</b> or Not: Click Decline</p>
            <form method="post">
