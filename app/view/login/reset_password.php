...
<?php
    ...
    $pass = '';
    $pass_confirm = '';
    $displayEmail = filter_input(INPUT_GET, 'email', FILTER_SANITIZE_EMAIL);
        ...
        if (filter_var($email, FILTER_SANITIZE_EMAIL) === false) {
            ...
            if (isset($_POST['email']) && isset($_POST['pass']) &&
                ...
                if (empty($email)) {
                    ...
                    $result = login_controller::set_recover_password($email, $pass_confirm);
                    if ($result['code'] == 0) {
            ...
            if (!empty($error)) {
                ...
                <form novalidate method="post" action="" class="border rounded w-100 mb-5 mx-auto px-3 pt-3 bg-light">
                    <div class="form-group">
                        ...
                        <input readonly value="<?= $displayEmail ?>" name="email" id="email" type="text" class="form-control" placeholder="Email address">
                    </div>
                    <div class="form-group">
